...
#SBATCH --output=out/%N-2nodes_qwen3_5_4b_lora_sft_Scene30k_traineval_5epochs_smallerframes-%j.out
...
# ---------------------------------------------------------------------
# ------------ 2nodes_qwen3_5_4b_lora_sft_Scene30k_traineval_5epochs_smallerframes ----------
# ---------------------------------------------------------------------
#
# This script will train (SFT, LoRA) a Qwen3.5 model on the Scene30k dataset for 5 epochs. In this experiment, we use fewer frames. 
#
#

# ----- HEADER: ENV VARIABLES -----

EXPERIMENT_NAME="2nodes_qwen3_5_4b_lora_sft_Scene30k_traineval_5epochs_smallerframes"
...
OUTPUT_DIR="${PROJECT_DIR}/saves/qwen3_5-4b/lora/sft/Scene30k_traineval_5epochs_smallerframes"
