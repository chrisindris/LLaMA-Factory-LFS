...
# ---------------------------------------------------------------------
# ------------ 3nodes_qwen3_5_4b_lora_sft_Scene30k_traineval_5epochs ----------
# ---------------------------------------------------------------------
#
# This script will train (SFT, LoRA) a Qwen3.5 model on the Scene30k dataset for 5 epochs, distributed for 3 nodes.
#
#

# ----- HEADER: ENV VARIABLES -----

EXPERIMENT_NAME="3nodes_qwen3_5_4b_lora_sft_Scene30k_traineval_5epochs"
