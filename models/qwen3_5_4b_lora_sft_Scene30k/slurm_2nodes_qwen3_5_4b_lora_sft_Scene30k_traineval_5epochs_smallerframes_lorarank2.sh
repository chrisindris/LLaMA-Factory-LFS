...
#SBATCH --output=out/%N-2nodes_qwen3_5_4b_lora_sft_Scene30k_traineval_5epochs_smallerframes_lorarank2-%j.out
...
# ---------------------------------------------------------------------
# ------------ 2nodes_qwen3_5_4b_lora_sft_Scene30k_traineval_5epochs_smallerframes_lorarank2 ----------
# ---------------------------------------------------------------------
#
# This script will train (SFT, LoRA) a Qwen3.5 model on the Scene30k dataset for 5 epochs. In this experiment, we use fewer frames. Also, we set the LoRA rank to 2 (lora_rank: 2 in the YAML) to further reduce memory usage on l40s, but this is a hyperparameter that can be tuned for better performance.
#
#

# ----- HEADER: ENV VARIABLES -----

EXPERIMENT_NAME="2nodes_qwen3_5_4b_lora_sft_Scene30k_traineval_5epochs_smallerframes_lorarank2"
...
OUTPUT_DIR="${PROJECT_DIR}/saves/qwen3_5-4b/lora/sft/Scene30k_traineval_5epochs_smallerframes_lorarank2"
