...
#SBATCH --output=out/%N-qwen2_5vl_lora_sft_Scene30k_traineval_resumefromcheckpoint_debug-%j.out
...
${PROJECT_DIR}/models/qwen2_5vl_lora_sft_Scene30k/slurm_qwen2_5vl_lora_sft_Scene30k_traineval_resumefromcheckpoint_debug.sh "$@"