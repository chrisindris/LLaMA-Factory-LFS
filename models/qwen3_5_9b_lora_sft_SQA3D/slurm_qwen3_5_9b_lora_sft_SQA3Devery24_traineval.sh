...
#SBATCH --output=out/%N-qwen3_5_9b_lora_sft_SQA3Devery24_traineval-%j.out
...
EXPERIMENT_NAME="qwen3_5_9b_lora_sft_SQA3Devery24_traineval"
...
OUTPUT_DIR="${PROJECT_DIR}/saves/qwen3_5-9b/lora/sft/SQA3Devery24_traineval"
...
if [[ "$CLUSTER" == "RORQUAL" ]]; then
    ...
    if [[ "$RUNNING_MODE" == "APPTAINER" ]]; then
        ...
        #     --low_cpu_mem_usage \
        #     --output_dir /project/aip-wangcs/indrisch/LLaMA-Factory/saves/qwen3_5-9b/lora/sft/SQA3Devery24_traineval \
        #     --logging_steps 10 \
        #     --save_steps 200 \
        #     --plot_loss \
