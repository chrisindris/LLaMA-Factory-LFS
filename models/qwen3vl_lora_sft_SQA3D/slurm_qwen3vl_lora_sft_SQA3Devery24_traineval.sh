...
if [[ "$CLUSTER" == "RORQUAL" ]]; then
    ...
    if [[ "$RUNNING_MODE" == "APPTAINER" ]]; then
        ...
        apptainer run --nv --writable-tmpfs \
            ...
            pip freeze && llamafactory-cli train /project/aip-wangcs/indrisch/LLaMA-Factory/examples/train_lora/${CLUSTER,,}_qwen3vl_lora_sft_SQA3Devery24_traineval.yaml
    ...
    apptainer run --nv --writable-tmpfs \
        ...
        llamafactory-cli train /scratch/indrisch/LLaMA-Factory/examples/train_lora/${CLUSTER,,}_qwen3vl_lora_sft_SQA3Devery24_traineval.yaml
