...
#SBATCH --output=out/%N-videor1sft_lora_sft_Scene30k_traineval-%j.out
...
EXPERIMENT_NAME="videor1sft_lora_sft_Scene30k_traineval"
...
OUTPUT_DIR="${PROJECT_DIR}/saves/videor1sft/lora/sft/Scene30k_traineval"
