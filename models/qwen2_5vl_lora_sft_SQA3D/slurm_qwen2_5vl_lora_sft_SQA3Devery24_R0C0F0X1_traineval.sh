...
#SBATCH --output=out/R0C0F0X1/%N-qwen2_5vl_lora_sft_SQA3Devery24_R0C0F0X1_traineval-%j.out
...
apptainer run --nv --writable-tmpfs \
    ...
    llamafactory-cli train /scratch/indrisch/LLaMA-Factory/examples/train_lora/qwen2_5vl_lora_sft_SQA3Devery24_R0C0F0X1_traineval.yaml