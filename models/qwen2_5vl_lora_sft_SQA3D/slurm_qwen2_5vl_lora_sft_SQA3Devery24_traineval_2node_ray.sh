...
apptainer run --nv --writable-tmpfs \
    ...
    -B /scratch/indrisch/ \
    -B /scratch/indrisch/apptainer-home/ \
    -B /scratch/indrisch/apptainer-tmp/ \
    -W ${SLURM_TMPDIR} \
    ...
    /scratch/indrisch/easyr1_verl_sif/llamafactory_wandb.sif \
    llamafactory-cli train /scratch/indrisch/LLaMA-Factory/examples/train_lora/qwen2_5vl_lora_sft_SQA3Devery24_2node.yaml