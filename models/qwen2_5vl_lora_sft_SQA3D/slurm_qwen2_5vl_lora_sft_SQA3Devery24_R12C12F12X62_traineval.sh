...
#SBATCH --output=out/R12C12F12X62/%N-qwen2_5vl_lora_sft_SQA3Devery24_R12C12F12X62_traineval-%j.out
...
apptainer run --nv --writable-tmpfs \
    ...
    llamafactory-cli train /scratch/indrisch/LLaMA-Factory/examples/train_lora/qwen2_5vl_lora_sft_SQA3Devery24_R12C12F12X62_traineval.yaml