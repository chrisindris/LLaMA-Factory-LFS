...
#SBATCH --output=out/R1C0F0X0/%N-qwen2_5vl_lora_sft_SQA3Devery24_R1C0F0X0_traineval-%j.out
...
apptainer run --nv --writable-tmpfs \
    ...
    llamafactory-cli train /scratch/indrisch/LLaMA-Factory/examples/train_lora/qwen2_5vl_lora_sft_SQA3Devery24_R1C0F0X0_traineval.yaml