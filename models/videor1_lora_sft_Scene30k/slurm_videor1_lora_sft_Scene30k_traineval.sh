...
#SBATCH --output=out/%N-videor1_lora_sft_Scene30k_traineval-%j.out
...
EXPERIMENT_NAME="videor1_lora_sft_Scene30k_traineval"
...
OUTPUT_DIR="${PROJECT_DIR}/saves/videor1/lora/sft/Scene30k_traineval"
