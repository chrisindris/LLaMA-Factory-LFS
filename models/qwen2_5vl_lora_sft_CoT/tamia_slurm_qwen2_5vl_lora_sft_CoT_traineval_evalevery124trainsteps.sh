...
# ===  tamia_slurm_qwen2_5vl_lora_sft_CoT_traineval_evalevery124trainsteps.sh  ===
# Same as tamia_slurm_qwen2_5vl_lora_sft_CoT_traineval_evalevery10trainsteps.sh except:
...
#   sbatch tamia_slurm_qwen2_5vl_lora_sft_CoT_traineval_evalevery124trainsteps.sh
#
