...
# ===  vulcan_slurm_qwen2_5vl_lora_sft_CoT_traineval_evalevery10trainsteps_groksettings.sh  ===
#  
#  Prereqs:
...
#   sbatch vulcan_slurm_qwen2_5vl_lora_sft_CoT_traineval_evalevery10trainsteps_groksettings.sh
#
