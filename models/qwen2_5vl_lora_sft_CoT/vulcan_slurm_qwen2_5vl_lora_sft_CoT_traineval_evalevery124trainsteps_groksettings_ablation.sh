...
#SBATCH --output=out/%N-qwen2_5vl_lora_sft_CoT_traineval_evalevery124trainsteps_groksettings_ablation-%j.out
...
# ===  tamia_slurm_qwen2_5vl_lora_sft_CoT_traineval_evalevery124trainsteps_groksettings_ablation.sh  ===
# Same as tamia_slurm_qwen2_5vl_lora_sft_CoT_traineval_evalevery124trainsteps_groksettings_ablation.sh except:
...
#
#
# This is identical to tamia_slurm_qwen2_5vl_lora_sft_CoT_traineval_evalevery124trainsteps_groksettings.sh, but this is the ablation suggested in #7 of cot_sft_remedy_report.md
#
#  Prereqs:
...
#   sbatch tamia_slurm_qwen2_5vl_lora_sft_CoT_traineval_evalevery124trainsteps_groksettings_ablation.sh
#
...
EXPERIMENT_NAME="qwen2_5vl_lora_sft_CoT_traineval_evalevery124trainsteps_groksettings_ablation_taskid${SLURM_ARRAY_TASK_ID}"
...
# | Always set:
# |   output_dir: saves/qwen2_5vl-7b/lora/sft/CoT_traineval_evalevery124trainsteps_groksettings_ablation_ep${ENDING_EPOCH}/
# |   stop_at_global_step: $((ENDING_EPOCH * STEPS_PER_EPOCH))
# |
# | If STARTING_EPOCH > 0 (resume):
# |   resume_from_checkpoint / adapter_name_or_path:
# |     ${PROJECT_DIR}/saves/.../CoT_traineval_evalevery124trainsteps_groksettings_ablation_ep${STARTING_EPOCH}/checkpoint-$((STARTING_EPOCH * STEPS_PER_EPOCH))
...
export OUTPUT_DIR_SAVES="saves/qwen2_5vl-7b/lora/sft/CoT_traineval_evalevery124trainsteps_groksettings_ablation_taskid${SLURM_ARRAY_TASK_ID}_ep${ENDING_EPOCH}/" && echo "OUTPUT_DIR_SAVES: ${OUTPUT_DIR_SAVES}"
...
if [[ "${STARTING_EPOCH}" -gt 0 ]]; then
  export RESUME_CKPT="${PROJECT_DIR}/saves/qwen2_5vl-7b/lora/sft/CoT_traineval_evalevery124trainsteps_groksettings_ablation_taskid${SLURM_ARRAY_TASK_ID}_ep${STARTING_EPOCH}/checkpoint-$((STARTING_EPOCH * STEPS_PER_EPOCH))"
else
