...
# TamIA wrapper for CoT SFT (Scene30k + SpatialSSRL_coldstart + 3DThinker10k)
# on H100 (80GB) GPUs. Submit from models/qwen2_5vl_lora_sft_CoT/ so SLURM out/
# lands next to this script:
#   sbatch tamia_slurm_qwen2_5vl_lora_sft_CoT_traineval.sh
#
