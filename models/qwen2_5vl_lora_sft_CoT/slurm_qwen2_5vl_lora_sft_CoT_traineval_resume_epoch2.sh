...
# ---------------------------------------------------------------------
# ------ qwen2_5vl_lora_sft_CoT_traineval_resume_epoch2 ---------------
# ---------------------------------------------------------------------
#
# Continuous resume of CoT LoRA SFT from checkpoint-620 (~epoch 1) toward
# epoch 2, preserving the original 5-epoch cosine LR horizon + ZeRO-2 Adam.
#
# Base: Qwen2.5-VL-7B-Instruct  (NOT the merged dense model)
# Adapter/optim: saves/.../CoT_traineval/checkpoint-620
# Stops at global_step=1240 via stop_at_global_step while num_train_epochs=5.
#

# ----- HEADER: ENV VARIABLES -----

EXPERIMENT_NAME="qwen2_5vl_lora_sft_CoT_traineval_resume_epoch2"
...
OUTPUT_DIR="${PROJECT_DIR}/saves/qwen2_5vl-7b/lora/sft/CoT_traineval_resume_ep2"
RESUME_CKPT="${PROJECT_DIR}/saves/qwen2_5vl-7b/lora/sft/CoT_traineval/checkpoint-620"
