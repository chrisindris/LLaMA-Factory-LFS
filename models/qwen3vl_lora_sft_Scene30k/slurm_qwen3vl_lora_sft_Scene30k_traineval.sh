...
#SBATCH --output=out/%N-qwen3vl_lora_sft_Scene30k_traineval-%j.out
...
EXPERIMENT_NAME="qwen3vl_lora_sft_Scene30k_traineval"
...
OUTPUT_DIR="${PROJECT_DIR}/saves/qwen3vl/lora/sft/Scene30k_traineval"
