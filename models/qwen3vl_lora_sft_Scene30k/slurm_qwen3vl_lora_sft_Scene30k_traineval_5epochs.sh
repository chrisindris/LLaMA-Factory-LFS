...
# ---------------------------------------------------------------------
# ------------ qwen3vl_lora_sft_Scene30k_traineval_5epochs ----------
# ---------------------------------------------------------------------
#
# This script will train (SFT, LoRA) a Qwen3VL model on the Scene30k dataset for 5 epochs.
#
#

# ----- HEADER: ENV VARIABLES -----

EXPERIMENT_NAME="qwen3vl_lora_sft_Scene30k_traineval_5epochs"
...
OUTPUT_DIR="${PROJECT_DIR}/saves/qwen3vl/lora/sft/Scene30k_traineval_5epochs"
