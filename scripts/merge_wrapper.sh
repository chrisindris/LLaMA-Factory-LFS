...
DISABLE_VERSION_CHECK=1 python merge_lora_for_resume.py --base-model /scratch/indrisch/huggingface/hub/models--Qwen--Qwen2.5-VL-7B-Instruct/snapshots/cc594898137f460bfe9f0759e9844b3ce807cfb5/ --adapter-checkpoint /scratch/indrisch/LLaMA-Factory/saves/qwen2_5vl-7b/lora/sft/CoT_traineval/checkpoint-620/ --output-dir ../models/qwen2_5vl_lora_sft_CoT_merged/