...
#SBATCH --output=out/%N-qwen2_5vl_eval_SQA3Devery24_on_X62-%j.out
...
if [[ "$CLUSTER" == "RORQUAL" ]]; then
    ...
    YAML_FILE="/scratch/indrisch/LLaMA-Factory/examples/train_lora/${CLUSTER,,}_qwen2_5vl_eval_SQA3Devery24_on_X62.yaml"
    ...
    apptainer run --nv --writable-tmpfs \
        ...
        llamafactory-cli train /scratch/indrisch/LLaMA-Factory/examples/train_lora/${CLUSTER,,}_qwen2_5vl_eval_SQA3Devery24_on_X62.yaml
else 
