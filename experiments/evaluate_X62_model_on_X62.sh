...
#SBATCH --output=out/%N-qwen2_5vl_eval_X62_on_X62-%j.out
...
if [[ "$CLUSTER" == "RORQUAL" ]]; then
    ...
    RUNNING_MODE=$1 # this is optional; generally, we wouldn't use this
    YAML_FILE="/scratch/indrisch/LLaMA-Factory/examples/train_lora/${CLUSTER,,}_qwen2_5vl_eval_X62_on_X62.yaml"
    ...
    apptainer run --nv --writable-tmpfs \
        ...
        llamafactory-cli train /scratch/indrisch/LLaMA-Factory/examples/train_lora/${CLUSTER,,}_qwen2_5vl_eval_X62_on_X62.yaml
