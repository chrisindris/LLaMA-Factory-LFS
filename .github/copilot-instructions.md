...
`module load StdEnv/2023  gcc/12.3  openmpi/4.1.5 && module load python/3.12 cuda/12.6 opencv/4.12.0 && module load arrow && source /scratch/indrisch/venv_llamafactory_cu126_qwen35/bin/activate`

On Killarney, you can load the same modules and then source 
`/project/aip-wangcs/indrisch/venv_llamafactory_cu126_qwen35/bin/activate`
